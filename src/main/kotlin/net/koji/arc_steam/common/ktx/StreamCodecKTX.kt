...
package net.koji.arc_steam.common.ktx
...
object StreamCodecKTX {
    ...
    fun <B, C, T1, T2, T3, T4, T5, T6> composite(
        streamCodec1: StreamCodec<in B, T1>,
        method1: (C) -> T1,
        streamCodec2: StreamCodec<in B, T2>,
        method2: (C) -> T2,
        streamCodec3: StreamCodec<in B, T3>,
        method3: (C) -> T3,
        streamCodec4: StreamCodec<in B, T4>,
        method4: (C) -> T4,
        streamCoded5: StreamCodec<in B, T5>,
        method5: (C) -> T5,
        streamCoded6: StreamCodec<in B, T6>,
        method6: (C) -> T6,
